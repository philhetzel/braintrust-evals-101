import { projects, initDataset } from "braintrust";

const PROJECT_NAME: string = process.env.BRAINTRUST_PROJECT_NAME || "My App";
const MODEL: string = process.env.PREFERRED_MODEL || "gpt-4o";
...
async function createCountriesDataset() {
  const data = 
    [
        {
          "input": "France",
        ...
        },
        {
          ...
          "expected": {
            ...
            "government": "Federal presidential republic",
            "area": 758449,
            "short_history": "Mexico has a history of advanced pre-Columbian civilizations. The Spanish conquered it in the 16th century. It gained independence in 1821. Mexico experienced many internal conflicts and reforms. The Mexican Revolution began in 1910. It led to social and land reforms. Today, Mexico is a major Latin American economy. It has strong cultural and economic ties to the United States."
          },
          "metadata": {
            "continent": "North America"
          }
  ...
  const dataset = initDataset(PROJECT_NAME, { dataset: "Countries" });
